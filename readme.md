...
【1】 网文动不动上千章</br>
`但是其他所有的window阅读软件，都只针对章节较少的实体书进行设计：即一行通常只显示一个章节`</br>
作为读者**目录跳转非常不方便**</br> 
✅ `NovReader`一行显示多个章节，充分利用电脑大屏幕，跳转更方便</br>

【2】 很多小说**明明有分卷，但本地阅读器基本都不显示**</br>
&nbsp; &nbsp; &nbsp; &nbsp; 当出现上千个章节的独立标题时，`其他软件`难以掌握超长小说剧情的脉络</br>
✅ `NovReader`支持按分卷信息划分  &nbsp; ✅ `NovReader`即使小说没有分卷，也会自动对章节进行分页</br>
...
✅`NovReader`通过自动拆解长段落，使段落长短错落有致，从而提高读者的阅读浏览体验</br>
